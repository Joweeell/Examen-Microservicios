...
@RestController
@RequestMapping("/api/v2/productos") // Versión 2 con soporte HAL-JSON
...
public class ProductoControllerV2 {
    ...
    public CollectionModel<EntityModel<Producto>> getAllProductos() {
        // Obtenemos la lista normal de tu service
        List<Producto> listaPlana = productoService.obtenerTodos();

        // La convertimos a EntityModel usando el assembler uno por uno
