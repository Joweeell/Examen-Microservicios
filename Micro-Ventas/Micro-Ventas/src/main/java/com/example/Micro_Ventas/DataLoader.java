...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (ventaRepository.count() == 0) {
            ...
            // Generamos exactamente 10 registros comerciales correlativos
            for (long i = 1; i <= 10; i++) {
                Venta venta = new Venta();

                // Mapeo lógico cruzando los datos del ecosistema
                ...
                // Cálculo matemático exacto para el negocio transaccional 🚀
