...
@ActiveProfiles("test") // Conecta de forma segura a tu base de pruebas aislada
public class InventarioControllerTest {
    ...
    @BeforeEach
    void setUp() {
        // Configura un objeto simulado idéntico a tu modelo de negocio
    ...
    // 🧪 Test para la API Tradicional V1: Listar todo el Stock
    @Test
    ...
    // 🧪 Test para la API Tradicional V1: Buscar un registro por su ID de Inventario
    @Test
    ...
    // 🧪 Test para la API Tradicional V1: Buscar un registro por el ID de Producto
    @Test
