...
public class UsuarioControllerV2 {
    ...
    // 1. REPORTES PERSONALIZADOS CON HATEOAS (Basado en Página 4 y 5 de la Guía)
    ...
    public CollectionModel<EntityModel<Usuario>> getUsuariosByNombre(@PathVariable String nombre) {
        // Corregido: la lista del stream debe guardar objetos de tipo EntityModel<Usuario>
    ...
    // 2. REPORTE ADICIONAL: Filtrado por Rol del usuario
