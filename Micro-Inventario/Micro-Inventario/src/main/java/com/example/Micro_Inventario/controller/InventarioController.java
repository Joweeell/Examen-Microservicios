...
/*Primero creamos la existencia del producto en la bodega.
Si no haces esto primero, los otros métodos te darán error
porque no encontrarán nada que sumar o restar
* {
    "productoId": 1,
