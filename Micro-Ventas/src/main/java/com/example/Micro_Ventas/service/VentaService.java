...
public class VentaService {
    ...
    public Venta crearVenta(Venta venta) {
        ...
        // 2. OBTENER PRECIO DESDE MICRO_PRODUCTOS (Puerto 8081)
        ...
        // 5. Guarda transacción en (Puerto 8083)
        Venta ventaGuardada = ventaRepository.save(venta);

        // 6. (Creación automática del despacho - Puerto 8085)
